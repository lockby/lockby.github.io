  ...
  (t = function () {
    ...
    function _(e) {
      ...
      if (g(e) || v(e)) (r = e), (t = O(e)), (n = j(e));
        ...
        var o = e.name;
        if (((r = o), L.call(e, "weight") && (i = e.weight) <= 0))
          throw new Error(
            (function (e) {
                  ...
                  var n = t.pattern,
                    ...
                    y = (function (e, t, n) {
                      var r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
                        ...
                        h = r.findAllMatches,
                        f = void 0 === h ? I.findAllMatches : h,
                        l = r.minMatchCharLength,
                        d = void 0 === l ? I.minMatchCharLength : l,
                        v = r.includeMatches,
                      ...
                      for (
                        ...
                        var O = F(t, { currentLocation: m, expectedLocation: b, distance: a, ignoreLocation: p });
                        if (((x = Math.min(O, x)), (L = m + k), S)) for (var j = 0; j < k; ) (_[m + j] = 1), (j += 1);
                      }
                      L = -1;
                      for (var A = [], C = 1, E = k + M, $ = 1 << (k - 1), R = 0; R < k; R += 1) {
                        for (var W = 0, T = E; W < T; )
                          F(t, {
                            errors: R,
                            currentLocation: b + T,
      ...
      G = (function (e) {
        ...
        function n(e) {
          var i,
            ...
            u = void 0 === s ? I.threshold : s,
            h = o.distance,
            f = void 0 === h ? I.distance : h,
            l = o.includeMatches,
            d = void 0 === l ? I.includeMatches : l,
            v = o.findAllMatches,
              ...
              var t = this,
                n = (function (e, t) {
                  var n = (arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}).auto,
                    ...
                    i = function e(n) {
                      var i = Object.keys(n),
                        o = ue(n);
                      if (!o && i.length > 1 && !se(n)) return e(fe(n));
                      if (he(n)) {
                        var c = o ? n[ce] : i[0],
                          a = o ? n[ae] : n[c];
                ...
                r = function e(n, r, i) {
                  ...
                  for (var s = [], u = 0, h = n.children.length; u < h; u += 1) {
                    ...
                    if (f.length) s.push.apply(s, l(f));
